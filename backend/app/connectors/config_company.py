...
class ConfigurableCompanyConnector(BaseConnector):
    ...
    Instantiated dynamically from companies.json without code modification.
    """
    def __init__(self, company_config: Dict[str, Any]):
        ...
        self.version = "1.0.0"
        self.sample_roles = company_config.get("sample_roles", [])
    ...
    async def fetch(self) -> List[Dict[str, Any]]:
        ...
        for role in self.sample_roles:
            ...
            results.append({
                ...
                "external_apply_url": role.get("external_apply_url"),
                "salary": role.get("salary", "₹12 - ₹18 LPA"),
                "description": role.get("description", f"Technical role at {self.name}"),
